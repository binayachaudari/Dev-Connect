 ...
 * @access  Private
 */
router.route('/me').get(authenticateToken, myProfile).delete(authenticateToken, deleteProfile);
 ...
 * @access  Private
 */
router.route('/experience/:exp_id').put(authenticateToken, editExperience).delete(authenticateToken, deleteExperience);
 ...
 * @access  Private
 */
router.route('/education/:edu_id').put(authenticateToken, editEducation).delete(authenticateToken, deleteEducation);
 ...
 * @access  Public
 */
router.route('/github/:username').get(githubProfile);
